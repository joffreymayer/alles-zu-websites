...
- <u>Alternative **ohne** `@media`</>: Dieses [Youtube-Video von WebDev Simplified (ab 2:50-3:30)](https://www.youtube.com/watch?v=TlP5WIxVirU&t=2m50s) zeigt eine alternative Methode anhand von der `auto-fill`-property & `minmax()`-Funktion.
